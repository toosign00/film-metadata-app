        ...
        <form ref={formRef} onSubmit={onProcessFiles} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div className="bg-gray-900 rounded-lg border border-gray-700 p-4 shadow-md">
              ...
              <div className="mb-4">
                <label htmlFor="startDate" className="block text-gray-300 font-medium mb-1 text-sm">시작 날짜</label>
              ...
              <div>
                <label htmlFor="startTime" className="block text-gray-300 font-medium mb-1 text-sm">시작 시간</label>
                <div className="relative">
                  <input
                    type="time"
                    id="startTime"
            ...
            <div className="bg-gray-900 rounded-lg border border-gray-700 p-4 shadow-md">
              ...
              <div className="mb-4">
                <label htmlFor="cameraMake" className="block text-gray-300 font-medium mb-1 text-sm">카메라 제조사</label>
                <input
                  type="text"
                  id="cameraMake"
                  name="cameraMake"
              ...
              <div>
                <label htmlFor="cameraModel" className="block text-gray-300 font-medium mb-1 text-sm">카메라 모델</label>
                <input
                  type="text"
                  id="cameraModel"
                  name="cameraModel"
            ...
            <div className="bg-gray-900 rounded-lg border border-gray-700 p-4 shadow-md">
              ...
              <div className="mb-4">
                <label htmlFor="lens" className="block text-gray-300 font-medium mb-1 text-sm">렌즈</label>
                <input
                  type="text"
                  id="lens"
                  name="lens"
              ...
              <div>
                <label htmlFor="lensInfo" className="block text-gray-300 font-medium mb-1 text-sm">렌즈 정보</label>
                <input
                  type="text"
                  id="lensInfo"
                  name="lensInfo"
            ...
            <div className="bg-gray-900 rounded-lg border border-gray-700 p-4 shadow-md">
              ...
              <div className="mb-4">
                <label htmlFor="filmInfo" className="block text-gray-300 font-medium mb-1 text-sm">필름 정보</label>
                <input
                  type="text"
                  id="filmInfo"
                  name="filmInfo"
              ...
              <div>
                <label htmlFor="isoValue" className="block text-gray-300 font-medium mb-1 text-sm">ISO 값</label>
                <input
                  type="text"
                  id="isoValue"
                  name="isoValue"
            ...
            <Button
              ...
              icon={
                processing && completed > 0 ? (
                  <>
                    <span>{completed}/{sortedFiles.length}</span>
                  </>
                ) : null
              }
            >
