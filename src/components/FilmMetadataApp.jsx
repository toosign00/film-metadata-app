  ...
  return (
    <div className="max-w-4xl mx-auto bg-white shadow-xl rounded-xl overflow-hidden">
        ...
        <div className="flex justify-between items-center">
          <div className="flex space-x-1 w-full">
            ...
            >
              ...
              {files.length > 0 && <span className="ml-1 text-xs md:text-sm bg-white bg-opacity-20 text-white px-1.5 py-0.5 rounded-full">{files.length}</span>}
            </button>
            <button
              onClick={() => goToStep(2)}
            ...
            >
              ...
              {resultImages.length > 0 && <span className="ml-1 text-xs md:text-sm bg-white bg-opacity-20 text-white px-1.5 py-0.5 rounded-full">{resultImages.length}</span>}
            </button>
          </div>
          <button 
            onClick={resetForm}
            className="ml-2 text-sm text-gray-600 hover:text-red-600 transition-colors"
            title="모두 초기화"
          >
      ...
      <div className="p-4 md:p-6">
              ...
              >
                ...
                <div className="flex flex-col items-center justify-center py-5">
                  <svg xmlns="http://www.w3.org/2000/svg" className={`h-12 w-12 mb-2 ${
                    isDragging ? 'text-blue-600' : files.length > 0 ? 'text-blue-500' : 'text-gray-400'
              ...
              <button
                ...
                className={`px-5 py-2 rounded-lg ${
                  files.length === 0 
                    ...
                    : 'bg-blue-600 text-white hover:bg-blue-700 shadow transition'
                }`}
              >
                다음 단계 &rarr;
              </button>
            ...
            <form ref={formRef} onSubmit={processFiles} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div className="bg-white rounded-lg border border-blue-200 p-4 shadow-sm">
                  ...
                  <div className="mb-4">
                    <label htmlFor="startDate" className="block text-gray-700 font-medium mb-1 text-sm">시작 날짜</label>
                    ...
                    <p id="startDate-help" className="mt-1 text-xs text-gray-500">첫 번째 사진의 촬영 날짜</p>
                  </div>
                  
                  <div>
                    <label htmlFor="startTime" className="block text-gray-700 font-medium mb-1 text-sm">시작 시간</label>
                    <div className="relative">
                      <input
                        type="time"
                        id="startTime"
                    ...
                    <p id="startTime-help" className="mt-1 text-xs text-gray-500">첫 번째 사진의 촬영 시간</p>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-lg border border-blue-200 p-4 shadow-sm">
                  ...
                  <div className="mb-4">
                    <label htmlFor="cameraMake" className="block text-gray-700 font-medium mb-1 text-sm">카메라 제조사</label>
                    <input
                      type="text"
                      id="cameraMake"
                      name="cameraMake"
                    ...
                    />
                    <p id="cameraMake-help" className="mt-1 text-xs text-gray-500">카메라 브랜드명</p>
                  </div>
                  
                  <div>
                    <label htmlFor="cameraModel" className="block text-gray-700 font-medium mb-1 text-sm">카메라 모델</label>
                    <input
                      type="text"
                      id="cameraModel"
                      name="cameraModel"
                    ...
                    />
                    <p id="cameraModel-help" className="mt-1 text-xs text-gray-500">사용한 카메라 모델명</p>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-lg border border-blue-200 p-4 shadow-sm">
                  ...
                  <div className="mb-4">
                    <label htmlFor="lens" className="block text-gray-700 font-medium mb-1 text-sm">렌즈</label>
                    <input
                      type="text"
                      id="lens"
                      name="lens"
                    ...
                    />
                    <p id="lens-help" className="mt-1 text-xs text-gray-500">렌즈 브랜드와 시리즈</p>
                  </div>
                  
                  <div>
                    <label htmlFor="lensInfo" className="block text-gray-700 font-medium mb-1 text-sm">렌즈 정보</label>
                    <input
                      type="text"
                      id="lensInfo"
                      name="lensInfo"
                    ...
                    />
                    <p id="lensInfo-help" className="mt-1 text-xs text-gray-500">초점 거리와 조리개 값 (예: 50mm f1.8)</p>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-lg border border-blue-200 p-4 shadow-sm">
                  ...
                  <div className="mb-4">
                    <label htmlFor="filmInfo" className="block text-gray-700 font-medium mb-1 text-sm">필름 정보</label>
                    <input
                      type="text"
                      id="filmInfo"
                      name="filmInfo"
                    ...
                    />
                    <p id="filmInfo-help" className="mt-1 text-xs text-gray-500">필름 브랜드와 종류</p>
                  </div>
                  
                  <div>
                    <label htmlFor="isoValue" className="block text-gray-700 font-medium mb-1 text-sm">ISO 값</label>
                    <input
                      type="text"
                      id="isoValue"
                      name="isoValue"
                    ...
                    />
                    <p id="isoValue-help" className="mt-1 text-xs text-gray-500">필름의 ISO 감도</p>
                  </div>
                </div>
              </div>
                ...
                >
                  {processing && completed > 0 ? (
                    <div className="flex items-center">
                      ...
                      <span>처리 중... ({completed}/{sortedFiles.length})</span>
                    </div>
                  ) : (
        ...
        <section 
          ref={resultRef}
          className={`mb-8 transition-all ${activeStep === 3 ? 'block' : 'hidden'}`} 
                ...
                {resultImages.map((image, idx) => (
                  <div key={idx} className="relative group bg-white rounded-lg overflow-hidden shadow-sm border border-blue-100">
                    ...
                    <div className="p-2 bg-white">
                      <p className="text-xs font-medium text-gray-800 truncate" title={image.name}>{image.name}</p>
          ...
          <section className="mb-8" aria-labelledby="errors-section">
            <div className="p-4 bg-red-50 rounded-lg border border-red-200 shadow-sm">
              <div className="flex items-center mb-3">
                ...
                <h2 id="errors-section" className="text-lg font-bold text-red-700">오류 발생 ({errors.length}개)</h2>
              </div>
