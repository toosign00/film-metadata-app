...
/**
 * 커스텀 데이트피커 컴포넌트
 * @param {CustomDatePickerProps} props - 컴포넌트 속성
...
const CustomDatePicker: React.FC<CustomDatePickerProps> = ({
  ...
  // 커스텀 입력 컴포넌트
  const CustomInput = forwardRef<HTMLInputElement, CustomInputProps>(({ value, onClick, placeholder, disabled, id, name }, ref) => (
