  ...
  return (
    <div className="relative group bg-gray-800 rounded-lg overflow-hidden shadow-md border border-gray-700">
      ...
      <div className="p-2 bg-gray-800">
        <p className="text-xs font-medium text-gray-200 truncate" title={image.name}>{image.name}</p>
        <p className="text-xs text-gray-400 truncate" title={image.dateTime}>{image.dateTime}</p>
      </div>
    </div>
  );
};
